  ...
  <div>
    ...
    <div class="main__div">
      ...
      <div class="details"> 
        ...
        <h2 class="left__div__h2">Family Pack</h2>
        <p class="left__div__p">This is the second part of the SMM starter pack series of articles
          . If you made it this far, you must
           be willing to learn about promoting business through social media.</p> 
