...
<template>
  <div>
      ...
      <div class="payment_info" >
        ...
        <div class="row">
          ...
          <div class="form-group row">
            <div class="col-md-4 hotel_info">
              ...
              <el-input placeholder="hotelid" :disabled="true">
              </el-input>
            </div>
            <div class="col-md-4 ">
              <label>Hotel Name</label>
              <el-input placeholder="hotelname" :disabled="true">
              </el-input>
            </div>
            <div class="col-md-4">
              <label>Hotel price</label>
              <el-input placeholder="price" :disabled="true">
              </el-input>
            </div>
          </div>
          ...
          <div class="col-md-6 hotel_address_input ">
            ...
            <el-input placeholder="addres" :disabled="true">
            </el-input>
          </div>
          <div class="col-md-6 hotel_location_input">
            <label>Location</label>
            <el-input placeholder="location" :disabled="true">
            </el-input>
          </div>
        ...
        <div class="row hotel-desc">
          <div class="col-md-12">
            ...
            <el-input type="textarea" :rows="5" :disabled="true" placeholder="hotel desc">
            </el-input>
          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-6 flight_number_input">
                ...
                <el-input placeholder="FlightNumber" :disabled="true">
                </el-input>
              </div>
              <div class="col-md-6 flight_number_input">
                <label>Flight name</label>
                <el-input placeholder="FlightName" :disabled="true">
                </el-input>
              </div>
            </div>
            ...
            <div class="col-md-6 aircraft_name_input">
              ...
              <el-input placeholder="FlightDate" :disabled="true" suffix-icon="el-icon-date">
              </el-input>
            </div>
            <div class="col-md-6">
              <label>CompanyName</label>
              <el-input placeholder="CompanyName" :disabled="true">
              </el-input>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 aircraft_name_input">
            ...
            <el-input placeholder="AirCraftName" :disabled="true">
            </el-input>
          </div>
          <div class="col-md-4">
            <label>TailNumber</label>
            <el-input placeholder="TailNumber" :disabled="true">
            </el-input>
          </div>
          <div class="col-md-4 hotel_location_input">
            <label>MAXPassagerNumber</label>
            <el-input placeholder="MAXPassagerNumber" :disabled="true">
            </el-input>
          </div>
        </div>
        <br />
    ...
    <vue-html2pdf :show-layout="false" :float-layout="true" :enable-download="true" :preview-modal="false"
      :paginate-elements-by-height="1400" filename="voyagerPaymentDetails" :pdf-quality="10" :manual-pagination="false"
      pdf-format="a4" :pdf-margin="200" pdf-orientation="portrait" pdf-content-width="1390px"
